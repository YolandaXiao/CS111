...
#./lab2_list --threads=2 --iterations=1000 --lists=1 --sync=m >> lab_2b_list.csv
...
./lab2_list --threads=2 --iterations=1000 --lists=1 --sync=s >> lab_2b_list.csv
...
/u/cs/grad/zhou/iloveos/gnuplot lab2_list.gp lab_2b_list.csv
